            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Enter your menu" value="<?= isset($_GET['edit']) ? $rowedit['name'] : "" ?>" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="parent_id" id="" class="form-control">
                            ...
                            <?php foreach ($rowparentid as $parentid): ?>
                                <option value="<?php echo $parentid['id'] ?>" <?php echo isset($_GET['edit']) && $rowedit['parent_id'] == $parentid['id'] ? 'selected' : '' ?>>
                                    <?php echo $parentid['name'] ?>
                                </option>
                            <?php endforeach ?>
                        </select>
                        <!-- <input type="text" class="form-control" name="name" placeholder="Enter your menu" value="<?= isset($_GET['edit']) ? $rowedit['parent_id'] : "" ?>"> -->
                    </div>
                    <div class="mb-3">
                        <label for="">Icon *</label>
                        <input type="text" class="form-control" name="icon" placeholder="Enter icon menu" value="<?= isset($_GET['edit']) ? $rowedit['icon'] : "" ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="">Url</label>
                        <input type="text" class="form-control" name="url" placeholder="Enter url menu" value="<?= isset($_GET['edit']) ? $rowedit['url'] : "" ?>">
                    </div>
                    <div class="mb-3">
                        <label for="">Order</label>
                        <input type="number" class="form-control" name="urutan" placeholder="Enter order menu" value="<?= isset($_GET['edit']) ? $rowedit['urutan'] : "" ?>">
                    </div>
                    <div class="mb-3">
